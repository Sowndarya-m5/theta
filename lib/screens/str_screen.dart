...
class StrDetails extends StatefulWidget {
  final StrDataModel strDataModel;
  const StrDetails({Key? key, required this.strDataModel}) : super(key: key);

  @override
  State<StrDetails> createState() => _StrDetailsState();
}

class _StrDetailsState extends State<StrDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime eventDateTime = DateFormat(
      "dd.MM.yyyy hh:mm a",
    ).parse("${widget.strDataModel.date} ${widget.strDataModel.time}");
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Image.asset(widget.strDataModel.ImageUrl,width: 500, height: 500,),
            ),
            SizedBox(height: 18),
            Padding(
                ...
                child: Column(
                  children: [
                    if (now.isBefore(registrationDeadline))
                      ElevatedButton(
                        onPressed: () async {
                          String googleFormUrl = widget.strDataModel.reglink;
